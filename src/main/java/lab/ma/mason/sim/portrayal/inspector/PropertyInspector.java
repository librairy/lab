...
import lab.ma.mason.sim.display.*;
        ...
        for(int x = 0; x < classes.numObjs; x++)
            ...
            menu.addActionListener(new ActionListener() 
                ...
                public void actionPerformed(ActionEvent e)
                    {
                    PropertyInspector inspector = PropertyInspector.makeInspector(theClass, properties, index, (lab.ma.mason.sim.display.Console)(state.controller), state);
