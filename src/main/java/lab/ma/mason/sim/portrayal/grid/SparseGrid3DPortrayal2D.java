...
import lab.ma.mason.sim.field.grid.Grid3D;
import lab.ma.mason.sim.field.grid.SparseGrid3D;
import lab.ma.mason.sim.portrayal.*;
import lab.ma.mason.sim.portrayal.inspector.StableInt3D;
...
public class SparseGrid3DPortrayal2D extends SparseGridPortrayal2D
    ...
    public LocationWrapper getWrapper(Object object)
        {
        final SparseGrid3D field = (SparseGrid3D) this.field;
        final StableInt3D w = new StableInt3D(field, object);
