...
import lab.ma.mason.sim.util.gui.DisclosurePanel;
...
import lab.ma.mason.sim.util.media.chart.SeriesAttributes;
...
/** An abstract superclass for property inspectors which use sim.util.ChartGenerator to produce charts.
    ...
    rather is stored in GUIState.storage under the key chartKey ("ChartingPropertyInspector")
*/
...
public abstract class ChartingPropertyInspector extends PropertyInspector
    ...
    public final static String chartKey = "ChartingPropertyInspector";
