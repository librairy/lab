...
import lab.ma.mason.sim.util.Valuable;
import lab.ma.mason.sim.util.media.chart.ChartGenerator;
import lab.ma.mason.sim.util.media.chart.HistogramGenerator;
import lab.ma.mason.sim.util.media.chart.XYChartGenerator;
