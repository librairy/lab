...
import lab.ma.mason.sim.portrayal.SimpleInspector;
...
import lab.ma.mason.sim.util.SimpleProperties;
...
public class TabbedInspector extends Inspector
    ...
    */
    ...
    public TabbedInspector(TabbableAndGroupable object, GUIState state, String name)
        {
        lab.ma.mason.sim.util.Properties properties = lab.ma.mason.sim.util.Properties.getProperties(object);
	...
	*/
	public TabbedInspector(Object[] objects, GUIState state, String name,
    	...
    	lab.ma.mason.sim.util.Properties[] properties = new SimpleProperties[objects.length];
    	
		for(int i = 0; i < objects.length; i++)
			properties[i] = lab.ma.mason.sim.util.Properties.getProperties(objects[i]);
	...
	/** Creates a TabbedInspector with separate tabbed subinspectors for each of the
		...
		in windows or higher-level tabs).   
	*/
	public TabbedInspector(lab.ma.mason.sim.util.Properties[] properties, GUIState state, String name,
                           String title, String[] tabNames)
		{
		buildTabbedInspector(properties, state, name, title, tabNames);
		}
	...
	// tabNames is a list of tab names
    void buildTabbedInspector(lab.ma.mason.sim.util.Properties[] properties, GUIState state, String name,
                              String title, String[] tabNames)
        {
        buildTabbedInspector(name, true);
