...
import lab.ma.mason.sim.engine.Schedule;
import lab.ma.mason.sim.engine.SimState;
import lab.ma.mason.sim.engine.Steppable;
...
public abstract class GUIState
    ...
    public Controller createController()
        {
        lab.ma.mason.sim.display.Console console = new lab.ma.mason.sim.display.Console(this);
    ...
    */
    ...
    public lab.ma.mason.sim.util.Properties getSimulationProperties()
        {
        return null;
        }
    ...
    /** Returns an object with various property methods (getFoo(...), isFoo(...), setFoo(...)) whose
        ...
        Properties's domFoo(...) domain declarations to allow for sliders and pop-up lists.*/
