 ...
 *  of Objects or a <tt>Interval</tt>.  If no domain function exists, or if the domain function
 ...
 *
 *  <p>If the object provided to SimpleProperties is Proxiable, then SimpleProperties will call
 ...
 * </tt></pre>
 *
 *  <p>If the object provided to SimpleProperties is Propertied, then SimpleProperties will not
...
public class SimpleProperties extends lab.ma.mason.sim.util.Properties implements java.io.Serializable
    {
    ...
    lab.ma.mason.sim.util.Properties auxillary = null;  // if non-null, we use this properties instead
    ...
    */
    public SimpleProperties(Object o, boolean includeSuperclasses, boolean includeGetClass, boolean includeExtensions, boolean allowProxy)
        {
        object = o;
        if (allowProxy && o!=null && o instanceof Proxiable)
            object = ((Proxiable)(o)).propertiesProxy();
        else if (allowProxy && o !=null && o instanceof Propertied)
