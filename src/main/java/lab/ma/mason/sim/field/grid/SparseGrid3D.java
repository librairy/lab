...
import lab.ma.mason.sim.field.SparseField;
import lab.ma.mason.sim.field.SparseField3D;
...
*/
    ...
    */
    ...
    public void getRadialLocations( final int x, final int y, final int z, final double dist, int mode, boolean includeOrigin, IntBag xPos, IntBag yPos, IntBag zPos )
        {
        getRadialLocations(x, y, z, dist, mode, includeOrigin, ANY, true, xPos, yPos, zPos);
        }
    ...
    public void getRadialLocations( final int x, final int y, final int z, final double dist, int mode, boolean includeOrigin, int measurementRule, boolean closed, IntBag xPos, IntBag yPos, IntBag zPos )
        ...
        if (measurementRule != ANY && measurementRule != ALL && measurementRule != CENTER)
            {
    ...
    public Bag getRadialNeighborsAndLocations( final int x, final int y, final int z, final double dist, int mode, boolean includeOrigin, Bag result, IntBag xPos, IntBag yPos, IntBag zPos )
        {
        return getRadialNeighborsAndLocations(x, y, z, dist, mode, includeOrigin, ANY, true, result, xPos, yPos, zPos);
        }
