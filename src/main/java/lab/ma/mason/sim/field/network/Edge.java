...
package lab.ma.mason.sim.field.network;
...
/**
   ...
   edge.  If your "info" object is a Number or a MutableDouble, or is Valuable, then the
   ...
   Numbers or are Valuable.  In this case, the comparison is such that lower
   values sort first.
